...
class MainViewController: UIViewController {
    ...
    private func setupTableView() {
        ...
        aqiTableView.register(UINib(nibName: "AQITableViewCell", bundle: nil),
                              forCellReuseIdentifier: AQITableViewCell.idenrifier)
    }
...
extension MainViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: AQITableViewCell.idenrifier,
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        nextVC.conty = aqiArray[indexPath.row].county + aqiArray[indexPath.row].sitename
        nextVC.status = aqiArray[indexPath.row].status
        nextVC.aqi = aqiArray[indexPath.row].aqi.toInt()
